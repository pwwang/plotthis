...
detect_upset_datatype <- function(data, group_by = NULL, id_by = NULL) {
    ...
    stop("Invalid data type. Please provide a data frame, a list or an UpsetPlotData object generated by ProcessUpsetData().")
}

#' Upset Plot
#'
#' @description ProcessUpsetData() is used to process the input data for Upset plot. UpsetPlot() is used to plot the processed data.
#' @rdname upsetplot
#' @export
...
#' }
#'
#' An UpsetPlotData object is generated by ProcessUpsetData() would look like:
#' \preformatted{
#' group_by
#' --------
#' list("A")  # a2
...
ProcessUpsetData <- function(data, intype = NULL, group_by = NULL, group_by_sep = "_", id_by = NULL) {
    if (is.null(intype)) {
...
#' @inheritParams ProcessUpsetData
...
UpsetPlotAtomic <- function(
    ...
    data <- ProcessUpsetData(data, intype, group_by, group_by_sep, id_by)
