...
- **Panwen Wang**. Author, maintainer.
  [](https://orcid.org/0000-0002-4614-8970)

## Citation

Source:
[`DESCRIPTION`](https://github.com/pwwang/plotthis/blob/master/DESCRIPTION)

Wang P (2026). *plotthis: High-Level Plotting Built Upon 'ggplot2' and
Other Plotting Packages*. R package version
0.13.3-4https://github.com/pwwang/plotthis
...
https://pwwang.github.io/plotthis/](https://github.com/pwwang/plotthis%20%20%20%20https://pwwang.github.io/plotthis/).
    ...
    @Manual{,
      ...
      author = {Panwen Wang},
      year = {2026},
      note = {R package version 0.13.3-4https://github.com/pwwang/plotthis
